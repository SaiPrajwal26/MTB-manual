...
LAYOUT = [
    ...
    [("btn","SAM COIL"),  ("lbl",""),("lbl",""), ("lbl","UMB2 STATUS"), ("ent","open")],
    [("btn","OBP"), ("lbl","Ext current(A)"), ("ent",""), ("lbl","Tm STATUS"), ("ent","Non--?")],
    [("btn","SCU"), ("lbl","int voltage(V)"), ("ent",""),("lbl","OBP LINK status"), ("ent","down")],
    [("btn","CGU"),  ("lbl","Pressure switch status"), ("ent","open")],
    [("btn","RPF"), ("lbl","int current(A)"), ("ent",""), ("lbl","SAM relay"), ("ent","open")],
    [("btn","INT SUPPLY"), ("lbl","int Volatage label 2"), ("ent",""), ("lbl","Switch status"), ("ent","open")],
    [ ("sp",3),("lbl","GND PYRO relay"), ("ent","open")],
    [ ("sp",3),("lbl","NOZZLE relay status"), ("ent","open")],
    [ ("sp",3),("lbl","Sustainer relay Status"), ("ent","")],
    [ ("sp",3),("lbl","Nozzle Mating Status"), ("ent","")],
    [ ("sp",3),("lbl","Wing  cage Status"), ("ent","")],
