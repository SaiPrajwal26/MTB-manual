...
PAGE_TITLE = "MANUAL CONTROL WINDOW"

LAYOUT = [

    [("btn","sensor data"), ("combo","TCP 1"),
     ("lbl","EXT VOL"), ("ent",""),
     ("lbl","roll rate"), ("ent","")],

    [("btn","Sensor Sign"), ("combo","0 V"),
     ("lbl","EXT CURRENT"), ("ent",""),
     ("lbl","pitch rate"), ("ent","")],
    ...
    [("btn","Wing uncage"), ("sp",1),
     ("lbl","TB MON VOLTAGE"), ("ent",""),
     ("lbl","Ay"), ("ent","")],

    [("btn","wing cage"), ("combo","TCP 1"),
     ("lbl","UMBILICAL 1"), ("ent",""),
     ("lbl","Az"), ("ent","")],

    [("btn","Actuator Null"), ("sp",1),
     ("lbl","NON LINEARITY"), ("ent",""),
     ("lbl","lift off"), ("ent","")],
